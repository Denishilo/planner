...
test('new array should be added when new todolist is added', () => {
    ...
    const action = todosThunks.addTodo.fulfilled(arg,'requestId',arg.todolist.title);
...
test('propertry with todolistId should be deleted', () => {
    const action = todosThunks.removeTodo.fulfilled({todolistId: "todolistId2"},'requestId',"todolistId2");
...
test('empty arrays should be added when we set todolists', () => {
    const action = todoActions.setTodolists({
        todolists: [
